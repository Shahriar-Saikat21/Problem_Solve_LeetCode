...
as part of the constructor. The pointer should be initialized to a non-existent number smaller than any element 
in the BST.
...
we can also use vector insted of stack but stack gives better TO 
*/
